...
* Active Directory: Active Directory Object Modification - 9
* Application Log: Application Log Content - 92
...
* File: File Metadata - 42
* File: File Modification - 47
...
* Internet Scan: Response Metadata - 8
* Logon Session: Logon Session Creation - 45
* Logon Session: Logon Session Metadata - 26
* Malware Repository: Malware Content - 5
* Malware Repository: Malware Metadata - 15
* Module: Module Load - 39
* Named Pipe: Named Pipe Metadata - 2
* Network Share: Network Share Access - 9
* Network Traffic: Network Connection Creation - 89
* Network Traffic: Network Traffic Content - 135
* Network Traffic: Network Traffic Flow - 113
* Persona: Social Media - 1
* Process: OS API Execution - 79
* Process: Process Access - 13
* Process: Process Creation - 229
* Process: Process Metadata - 24
...
* User Account: User Account Authentication - 29
...
* Windows Registry: Windows Registry Key Creation - 23
