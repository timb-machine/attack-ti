...
* Application Log: Application Log Content - 113
...
* Command: Command Execution - 292
* Container: Container Creation - 1
* Container: Container Start - 1
* Domain Name: Active DNS - 9
* Domain Name: Domain Registration - 10
* Domain Name: Passive DNS - 9
* Drive: Drive Access - 2
* Drive: Drive Creation - 3
* Drive: Drive Modification - 2
* Driver: Driver Load - 14
* File: File Access - 62
* File: File Creation - 118
* File: File Deletion - 7
* File: File Metadata - 50
* File: File Modification - 58
...
* Internet Scan: Response Content - 32
* Internet Scan: Response Metadata - 12
* Logon Session: Logon Session Creation - 51
* Logon Session: Logon Session Metadata - 29
* Malware Repository: Malware Content - 7
* Malware Repository: Malware Metadata - 18
* Module: Module Load - 48
* Named Pipe: Named Pipe Metadata - 2
* Network Share: Network Share Access - 9
* Network Traffic: Network Connection Creation - 105
* Network Traffic: Network Traffic Content - 163
* Network Traffic: Network Traffic Flow - 143
* Persona: Social Media - 3
* Process: OS API Execution - 102
* Process: Process Access - 17
...
* User Account: User Account Authentication - 32
...
* Windows Registry: Windows Registry Key Modification - 42
