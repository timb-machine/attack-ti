...
* File: File Access - 19
* File: File Content - 6
* File: File Creation - 27
* File: File Deletion - 4
* File: File Metadata - 17
* File: File Modification - 14
...
* Network Traffic: Network Traffic Content - 31
* Network Traffic: Network Traffic Flow - 28
* Process: OS API Execution - 32
* Process: Process Access - 4
* Process: Process Creation - 82
