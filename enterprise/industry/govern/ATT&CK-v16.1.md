...
* Exploitation for Client Execution - 23
* Exploitation for Privilege Escalation - 8
...
* Masquerading - 7
* Match Legitimate Name or Location - 24
...
* collection - 116
* command-and-control - 142
* credential-access - 111
* defense-evasion - 338
* discovery - 233
* execution - 258
* exfiltration - 35
...
* Application Log: Application Log Content - 240
...
* Command: Command Execution - 863
* Container: Container Creation - 2
* Container: Container Start - 1
* Domain Name: Active DNS - 20
* Domain Name: Domain Registration - 20
* Domain Name: Passive DNS - 20
* Drive: Drive Access - 1
* Drive: Drive Creation - 6
* Drive: Drive Modification - 1
* Driver: Driver Load - 40
* File: File Access - 176
* File: File Creation - 355
* File: File Deletion - 24
* File: File Metadata - 140
* File: File Modification - 179
* Firewall: Firewall Disable - 5
* Firewall: Firewall Enumeration - 21
* Firewall: Firewall Metadata - 21
* Firewall: Firewall Rule Modification - 5
* Group: Group Enumeration - 25
* Group: Group Modification - 2
* Image: Image Creation - 1
* Image: Image Deletion - 1
* Image: Image Metadata - 31
* Instance: Instance Creation - 2
* Instance: Instance Deletion - 2
* Instance: Instance Metadata - 2
* Instance: Instance Start - 1
* Internet Scan: Response Content - 55
* Internet Scan: Response Metadata - 17
* Logon Session: Logon Session Creation - 107
* Logon Session: Logon Session Metadata - 57
* Malware Repository: Malware Content - 15
* Malware Repository: Malware Metadata - 47
* Module: Module Load - 146
* Named Pipe: Named Pipe Metadata - 6
* Network Share: Network Share Access - 23
* Network Traffic: Network Connection Creation - 258
* Network Traffic: Network Traffic Content - 421
* Network Traffic: Network Traffic Flow - 406
* Persona: Social Media - 10
* Process: OS API Execution - 343
* Process: Process Access - 69
* Process: Process Creation - 850
* Process: Process Metadata - 90
* Process: Process Modification - 13
* Process: Process Termination - 12
* Scheduled Job: Scheduled Job Creation - 28
* Scheduled Job: Scheduled Job Metadata - 17
* Scheduled Job: Scheduled Job Modification - 17
* Script: Script Execution - 195
* Sensor Health: Host Status - 14
* Service: Service Creation - 28
* Service: Service Metadata - 32
* Service: Service Modification - 8
* Snapshot: Snapshot Deletion - 1
* User Account: User Account Authentication - 66
* User Account: User Account Creation - 20
...
* Windows Registry: Windows Registry Key Access - 50
* Windows Registry: Windows Registry Key Creation - 86
* Windows Registry: Windows Registry Key Deletion - 24
* Windows Registry: Windows Registry Key Modification - 123
...
* https://www.cidersecurity.io/top-10-cicd-security-risks/ - Daniel Krivelevich and Omer Gil. (n.d.). Top 10 CI/CD Security Risks. Retrieved March 24, 2024.
...
* https://www.proofpoint.com/us/blog/threat-insight/ta413-leverages-new-friarfox-browser-extension-target-gmail-accounts-global - Raggi, Michael. Proofpoint Threat Research Team. (2021, February 25). TA413 Leverages New FriarFox Browser Extension to Target the Gmail Accounts of Global Tibetan Organizations. Retrieved February 26, 2024.
...
* https://www.sans.org/cyber-security-summit/archives/file/summit-archive-1554718868.pdf - Karim, T. (2018, August). TRAILS OF WINDSHIFT. Retrieved June 25, 2020.
