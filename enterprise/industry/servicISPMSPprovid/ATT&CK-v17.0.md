...
* Active Directory: Active Directory Object Access - 7
* Active Directory: Active Directory Object Creation - 3
* Active Directory: Active Directory Object Deletion - 1
* Active Directory: Active Directory Object Modification - 8
* Application Log: Application Log Content - 125
...
* Internet Scan: Response Metadata - 14
* Logon Session: Logon Session Creation - 57
* Logon Session: Logon Session Metadata - 33
* Malware Repository: Malware Content - 8
* Malware Repository: Malware Metadata - 22
* Module: Module Load - 47
* Named Pipe: Named Pipe Metadata - 2
* Network Share: Network Share Access - 9
* Network Traffic: Network Connection Creation - 112
* Network Traffic: Network Traffic Content - 178
* Network Traffic: Network Traffic Flow - 154
* Persona: Social Media - 4
* Process: OS API Execution - 103
* Process: Process Access - 19
* Process: Process Creation - 286
...
* User Account: User Account Authentication - 35
* User Account: User Account Creation - 10
* User Account: User Account Metadata - 3
* User Account: User Account Modification - 10
* Volume: Volume Enumeration - 1
* WMI: WMI Creation - 11
* Web Credential: Web Credential Usage - 1
* Windows Registry: Windows Registry Key Access - 15
* Windows Registry: Windows Registry Key Creation - 29
* Windows Registry: Windows Registry Key Deletion - 6
* Windows Registry: Windows Registry Key Modification - 47
