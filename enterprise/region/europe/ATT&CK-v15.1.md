...
* Match Legitimate Name or Location - 13
* Modify Registry - 3
* Mshta - 5
* Msiexec - 2
...
* Application Log: Application Log Content - 97
...
* File: File Access - 69
* File: File Creation - 156
* File: File Deletion - 12
* File: File Metadata - 66
* File: File Modification - 72
...
* Module: Module Load - 72
* Named Pipe: Named Pipe Metadata - 1
* Network Share: Network Share Access - 8
* Network Traffic: Network Connection Creation - 125
* Network Traffic: Network Traffic Content - 186
* Network Traffic: Network Traffic Flow - 173
* Persona: Social Media - 6
* Process: OS API Execution - 138
* Process: Process Access - 31
* Process: Process Creation - 379
* Process: Process Metadata - 43
...
* Windows Registry: Windows Registry Key Modification - 66
