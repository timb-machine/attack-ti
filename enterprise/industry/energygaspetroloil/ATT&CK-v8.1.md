...
* Azure activity logs - 6
* Binary file metadata - 15
* DLL monitoring - 16
* DNS records - 4
...
* Packet capture - 48
* PowerShell logs - 30
* Process command-line parameters - 143
* Process monitoring - 191
* Process use of network - 51
* SSL/TLS inspection - 14
* Stackdriver logs - 9
* System calls - 7
* WMI Objects - 1
* Web proxy - 10
