...
* Application Log: Application Log Content - 198
...
* Network Traffic: Network Connection Creation - 225
* Network Traffic: Network Traffic Content - 370
* Network Traffic: Network Traffic Flow - 282
* Persona: Social Media - 8
* Process: OS API Execution - 324
* Process: Process Access - 64
* Process: Process Creation - 733
