...
* Digital Certificate Validation - 18
* File monitoring - 5
...
* Host intrusion prevention systems - 36
* Log Analysis - 4
* Log analysis - 22
...
* Network Traffic: Network Traffic Content - 113
* Network Traffic: Network Traffic Flow - 125
* Process: OS API Execution - 85
* Process: Process Access - 19
* Process: Process Creation - 279
