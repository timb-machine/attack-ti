...
* API monitoring - 52
* AWS CloudTrail logs - 22
* Access tokens - 1
* Anti-virus - 28
* Application logs - 9
* Asset management - 1
* Authentication logs - 53
* Azure activity logs - 12
* BIOS - 1
* Binary file metadata - 39
* DLL monitoring - 41
* DNS records - 12
* Data loss prevention - 5
* Detonation chamber - 22
* Email gateway - 34
...
* Packet capture - 95
* PowerShell logs - 38
* Process command-line parameters - 263
* Process monitoring - 347
* Process use of network - 99
