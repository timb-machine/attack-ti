...
* File: File Access - 81
* File: File Creation - 128
* File: File Deletion - 16
* File: File Metadata - 62
...
* Malware Repository: Malware Metadata - 26
* Module: Module Load - 58
* Named Pipe: Named Pipe Metadata - 4
* Network Share: Network Share Access - 12
* Network Traffic: Network Connection Creation - 106
* Network Traffic: Network Traffic Content - 151
* Network Traffic: Network Traffic Flow - 155
* Persona: Social Media - 2
* Process: OS API Execution - 143
* Process: Process Access - 35
* Process: Process Creation - 348
* Process: Process Metadata - 38
...
* Windows Registry: Windows Registry Key Creation - 30
