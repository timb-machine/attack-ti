...
* Credentials from Web Browsers - 7
...
* Python - 4
* Query Registry - 7
* Registry Run Keys / Startup Folder - 18
* Regsvr32 - 4
...
* Application control by file name or path - 35
* Binary Analysis - 2
...
* Host forensic analysis - 54
* Host intrusion prevention systems - 53
* Log Analysis - 2
* Log analysis - 34
* Network intrusion detection system - 18
* Signature-based detection - 54
...
* API monitoring - 105
* AWS CloudTrail logs - 37
* Access tokens - 2
* Anti-virus - 60
* Application logs - 9
* Authentication logs - 79
* Azure activity logs - 32
* Binary file metadata - 90
* DLL monitoring - 54
* DNS records - 21
* Data loss prevention - 8
* Detonation chamber - 37
* Email gateway - 67
...
* MBR - 1
* Mail server - 46
* Malware reverse engineering - 36
* Named Pipes - 3
* Netflow/Enclave netflow - 135
* Network device logs - 14
* Network intrusion detection system - 64
* Network protocol analysis - 122
* OAuth audit logs - 2
* Office 365 account logs - 7
* Office 365 audit logs - 5
* Office 365 trace logs - 5
* Packet capture - 169
* PowerShell logs - 78
* Process command-line parameters - 537
* Process monitoring - 686
* Process use of network - 169
* SSL/TLS certificates - 1
* SSL/TLS inspection - 66
* Services - 6
...
* VBR - 1
* WMI Objects - 4
* Web application firewall logs - 4
* Web logs - 11
* Web proxy - 36
* Windows Error Reporting - 4
* Windows Registry - 83
* Windows event logs - 116
