...
* Whitelisting by file name or path - 21
* Windows User Account Control - 8

# Validate the following data sources

* API monitoring - 47
* AWS CloudTrail logs - 25
* Anti-virus - 29
* Application logs - 6
...
* Named Pipes - 4
* Netflow/Enclave netflow - 60
* Network device logs - 8
* Network intrusion detection system - 28
* Network protocol analysis - 46
* OAuth audit logs - 1
* Office 365 account logs - 17
* Office 365 trace logs - 2
* Packet capture - 71
* PowerShell logs - 28
* Process command-line parameters - 231
* Process monitoring - 321
* Process use of network - 83
