...
* Obfuscated Files or Information - 26
...
* System Network Configuration Discovery - 16
* System Network Connections Discovery - 10
* System Owner/User Discovery - 13
...
* Application control by file name or path - 51
* Autoruns Analysis - 1
* Binary Analysis - 1
* Digital Certificate Validation - 26
* File monitoring - 8
* File system access controls - 1
* Firewall - 19
* Heuristic detection - 5
* Host Intrusion Prevention Systems - 3
* Host forensic analysis - 62
* Host intrusion prevention systems - 68
* Log Analysis - 3
* Log analysis - 44
* Network intrusion detection system - 26
* Process whitelisting - 1
* Signature-based detection - 68
* Static File Analysis - 7
...
* File: File Creation - 247
* File: File Deletion - 21
* File: File Metadata - 107
* File: File Modification - 130
...
* Image: Image Metadata - 25
* Instance: Instance Metadata - 22
* Internet Scan: Response Content - 31
* Internet Scan: Response Metadata - 7
* Logon Session: Logon Session Creation - 73
* Logon Session: Logon Session Metadata - 39
* Malware Repository: Malware Content - 9
* Malware Repository: Malware Metadata - 30
* Module: Module Load - 109
* Named Pipe: Named Pipe Metadata - 3
* Network Share: Network Share Access - 14
* Network Traffic: Network Connection Creation - 198
* Network Traffic: Network Traffic Content - 321
* Network Traffic: Network Traffic Flow - 269
* Persona: Social Media - 8
* Pod: Pod Metadata - 2
* Process: OS API Execution - 274
* Process: Process Access - 63
* Process: Process Creation - 679
* Process: Process Metadata - 65
* Process: Process Modification - 13
* Process: Process Termination - 8
* Scheduled Job: Scheduled Job Creation - 21
* Scheduled Job: Scheduled Job Metadata - 17
* Scheduled Job: Scheduled Job Modification - 17
* Script: Script Execution - 147
* Sensor Health: Host Status - 11
* Service: Service Creation - 26
* Service: Service Metadata - 30
* Service: Service Modification - 5
* User Account: User Account Authentication - 44
...
* Windows Registry: Windows Registry Key Access - 38
* Windows Registry: Windows Registry Key Creation - 43
* Windows Registry: Windows Registry Key Deletion - 18
* Windows Registry: Windows Registry Key Modification - 93
...
* https://blog-assets.f-secure.com/wp-content/uploads/2019/10/15163418/CozyDuke.pdf - F-Secure Labs. (2015, April 22). CozyDuke: Malware Analysis. Retrieved December 10, 2015.
...
* https://www.welivesecurity.com/wp-content/uploads/2021/06/eset_gelsemium.pdf - Dupuy, T. and Faou, M. (2021, June). Gelsemium. Retrieved November 30, 2021.
