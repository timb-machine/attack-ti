...
* File: File Access - 37
* File: File Creation - 62
* File: File Deletion - 7
* File: File Metadata - 30
* File: File Modification - 35
...
* Logon Session: Logon Session Metadata - 17
...
* Network Traffic: Network Connection Creation - 63
* Network Traffic: Network Traffic Content - 100
* Network Traffic: Network Traffic Flow - 73
* Persona: Social Media - 1
* Process: OS API Execution - 60
* Process: Process Access - 10
* Process: Process Creation - 161
...
* Windows Registry: Windows Registry Key Access - 8
