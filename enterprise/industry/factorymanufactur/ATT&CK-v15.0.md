...
* Network Traffic: Network Traffic Content - 98
* Network Traffic: Network Traffic Flow - 82
* Persona: Social Media - 4
* Process: OS API Execution - 54
* Process: Process Access - 17
* Process: Process Creation - 160
...
* Windows Registry: Windows Registry Key Modification - 28
