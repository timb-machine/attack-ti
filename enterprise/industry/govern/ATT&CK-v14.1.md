...
* Application Log: Application Log Content - 200
...
* File: File Access - 149
* File: File Creation - 294
...
* Logon Session: Logon Session Creation - 85
* Logon Session: Logon Session Metadata - 45
...
* Network Traffic: Network Connection Creation - 218
* Network Traffic: Network Traffic Content - 366
* Network Traffic: Network Traffic Flow - 327
* Persona: Social Media - 8
* Process: OS API Execution - 317
* Process: Process Access - 63
* Process: Process Creation - 757
...
* Windows Registry: Windows Registry Key Modification - 113
