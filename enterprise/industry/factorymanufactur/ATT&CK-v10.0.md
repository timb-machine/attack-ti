...
* Application control by file name or path - 13
...
* Logon Session: Logon Session Creation - 21
...
* Network Traffic: Network Connection Creation - 48
* Network Traffic: Network Traffic Content - 64
* Network Traffic: Network Traffic Flow - 55
* Persona: Social Media - 4
* Pod: Pod Metadata - 1
* Process: OS API Execution - 35
* Process: Process Access - 11
...
* User Account: User Account Authentication - 11
