...
* Application Log: Application Log Content - 26
...
* Module: Module Load - 19
* Network Share: Network Share Access - 4
* Network Traffic: Network Connection Creation - 42
* Network Traffic: Network Traffic Content - 54
* Network Traffic: Network Traffic Flow - 48
* Process: OS API Execution - 31
* Process: Process Access - 8
* Process: Process Creation - 127
...
* User Account: User Account Authentication - 10
...
* Windows Registry: Windows Registry Key Creation - 9
* Windows Registry: Windows Registry Key Deletion - 5
* Windows Registry: Windows Registry Key Modification - 17
