...
* Digital Certificate Validation - 22
* File Monitoring - 1
* File monitoring - 5
...
* Host Intrusion Prevention Systems - 34
* Host forensic analysis - 30
...
* Active Directory: Active Directory Object Modification - 10
* Application Log: Application Log Content - 124
...
* Cloud Storage: Cloud Storage Modification - 9
* Command: Command Execution - 522
...
* Driver: Driver Load - 26
* File: File Access - 101
* File: File Creation - 199
* File: File Deletion - 23
* File: File Metadata - 86
...
* Internet Scan: Response Content - 17
* Internet Scan: Response Metadata - 6
* Logon Session: Logon Session Creation - 76
* Logon Session: Logon Session Metadata - 41
* Malware Repository: Malware Content - 8
* Malware Repository: Malware Metadata - 31
* Module: Module Load - 96
* Named Pipe: Named Pipe Metadata - 4
* Network Share: Network Share Access - 21
* Network Traffic: Network Connection Creation - 156
* Network Traffic: Network Traffic Content - 223
* Network Traffic: Network Traffic Flow - 249
* Persona: Social Media - 2
* Process: OS API Execution - 193
* Process: Process Access - 45
* Process: Process Creation - 498
* Process: Process Metadata - 51
* Process: Process Modification - 7
* Process: Process Termination - 5
* Scheduled Job: Scheduled Job Creation - 17
* Scheduled Job: Scheduled Job Metadata - 10
* Scheduled Job: Scheduled Job Modification - 10
* Script: Script Execution - 102
* Sensor Health: Host Status - 7
* Service: Service Creation - 27
* Service: Service Metadata - 20
...
* User Account: User Account Creation - 11
...
* WMI: WMI Creation - 20
* Windows Registry: Windows Registry Key Access - 22
* Windows Registry: Windows Registry Key Creation - 54
...
* https://www.mandiant.com/sites/default/files/2021-09/rpt-apt38-2018-web_v5-1.pdf - FireEye. (2018, October 03). APT38: Un-usual Suspects. Retrieved November 6, 2018.
...
* https://success.trendmicro.com/solution/000283381 - Trend Micro. (2020, December 17). QAKBOT: A decade-old malware still with new tricks. Retrieved September 27, 2021.
...
* https://www.prevailion.com/phantom-in-the-command-shell-2/ - Adamitis, D. (2020, May 6). Phantom in the Command Shell. Retrieved December 22, 2021.
