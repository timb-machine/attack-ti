...
* Application Log: Application Log Content - 65
...
* Network Share: Network Share Access - 10
* Network Traffic: Network Connection Creation - 85
* Network Traffic: Network Traffic Content - 130
* Network Traffic: Network Traffic Flow - 107
* Persona: Social Media - 6
* Process: OS API Execution - 105
* Process: Process Access - 20
* Process: Process Creation - 233
