...
* Command: Command Execution - 213
* Driver: Driver Load - 7
* File: File Access - 44
* File: File Content - 11
* File: File Creation - 47
* File: File Deletion - 6
* File: File Metadata - 21
* File: File Modification - 27
...
* Network Traffic: Network Connection Creation - 59
* Network Traffic: Network Traffic Content - 72
* Network Traffic: Network Traffic Flow - 71
* Process: OS API Execution - 62
* Process: Process Access - 21
* Process: Process Creation - 166
...
* Windows Registry: Windows Registry Key Modification - 22
