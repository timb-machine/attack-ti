...
* Application Log: Application Log Content - 121
...
* Network Traffic: Network Connection Creation - 136
* Network Traffic: Network Traffic Content - 207
* Network Traffic: Network Traffic Flow - 164
* Persona: Social Media - 2
* Process: OS API Execution - 162
* Process: Process Access - 31
* Process: Process Creation - 395
