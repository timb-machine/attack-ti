...
* Module: Module Load - 79
* Named Pipe: Named Pipe Metadata - 4
* Network Share: Network Share Access - 13
* Network Traffic: Network Connection Creation - 119
* Network Traffic: Network Traffic Content - 186
* Network Traffic: Network Traffic Flow - 148
* Persona: Social Media - 2
* Process: OS API Execution - 139
* Process: Process Access - 27
* Process: Process Creation - 345
* Process: Process Metadata - 40
...
* User Account: User Account Authentication - 30
...
* Windows Registry: Windows Registry Key Modification - 67
...
* https://www.trendmicro.de/cloud-content/us/pdfs/security-intelligence/white-papers/wp-cpl-malware.pdf - Mercês, F. (2014, January 27). CPL Malware - Malicious Control Panel Items. Retrieved January 18, 2018.
