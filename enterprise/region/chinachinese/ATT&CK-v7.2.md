...
* API monitoring - 48
* AWS CloudTrail logs - 33
* Anti-virus - 27
* Application logs - 8
* Authentication logs - 55
* Azure activity logs - 26
* BIOS - 3
* Binary file metadata - 56
* DLL monitoring - 23
* DNS records - 9
...
* Named Pipes - 2
* Netflow/Enclave netflow - 78
* Network device logs - 10
* Network intrusion detection system - 32
* Network protocol analysis - 73
* Office 365 account logs - 3
* Office 365 audit logs - 1
* Office 365 trace logs - 2
* Packet capture - 89
* PowerShell logs - 37
* Process command-line parameters - 289
* Process monitoring - 374
* Process use of network - 98
* SSL/TLS inspection - 32
* Services - 4
* Stackdriver logs - 33
* System calls - 15
...
* VBR - 1
* WMI Objects - 1
* Web application firewall logs - 5
* Web logs - 5
* Web proxy - 15
* Windows Error Reporting - 2
* Windows Registry - 43
* Windows event logs - 61
...
* https://gist.github.com/campuscodi/74d0d2e35d8fd9499c76333ce027345a - Catalin Cimpanu. (2018, July 10). ~x file downloaded in public Arch package compromise. Retrieved April 23, 2019.
...
* https://lists.archlinux.org/pipermail/aur-general/2018-July/034153.html - Eli Schwartz. (2018, June 8). acroread package compromised. Retrieved April 23, 2019.
...
* https://www.bleepingcomputer.com/news/security/malware-found-in-arch-linux-aur-package-repository/ - Catalin Cimpanu. (2018, July 10). Malware Found in Arch Linux AUR Package Repository. Retrieved April 23, 2019.
