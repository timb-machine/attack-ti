...
* Application control by file name or path - 24
...
* File: File Access - 66
* File: File Creation - 108
* File: File Deletion - 13
* File: File Metadata - 55
...
* Network Traffic: Network Traffic Content - 143
* Network Traffic: Network Traffic Flow - 132
* Persona: Social Media - 1
* Pod: Pod Metadata - 2
* Process: OS API Execution - 101
* Process: Process Access - 23
* Process: Process Creation - 307
* Process: Process Metadata - 14
...
* https://github.com/peewpw/Invoke-PSImage - Adams, B. (2017, December 17). Invoke-PSImage. Retrieved April 10, 2018.
