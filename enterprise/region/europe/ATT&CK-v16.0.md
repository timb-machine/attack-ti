...
* Masquerading - 2
* Match Legitimate Name or Location - 15
...
* Application Log: Application Log Content - 120
...
* File: File Access - 86
* File: File Creation - 172
* File: File Deletion - 16
* File: File Metadata - 69
* File: File Modification - 86
...
* Logon Session: Logon Session Creation - 64
* Logon Session: Logon Session Metadata - 34
* Malware Repository: Malware Content - 7
* Malware Repository: Malware Metadata - 20
* Module: Module Load - 75
* Named Pipe: Named Pipe Metadata - 3
* Network Share: Network Share Access - 13
* Network Traffic: Network Connection Creation - 145
* Network Traffic: Network Traffic Content - 220
* Network Traffic: Network Traffic Flow - 214
* Persona: Social Media - 7
* Process: OS API Execution - 161
* Process: Process Access - 35
* Process: Process Creation - 424
* Process: Process Metadata - 50
...
* User Account: User Account Authentication - 37
...
* Windows Registry: Windows Registry Key Modification - 71
