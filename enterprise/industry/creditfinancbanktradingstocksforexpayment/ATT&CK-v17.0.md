...
* Active Directory: Active Directory Object Deletion - 3
* Active Directory: Active Directory Object Modification - 11
* Application Log: Application Log Content - 130
* Certificate: Certificate Registration - 1
* Cloud Service: Cloud Service Enumeration - 13
...
* Cloud Storage: Cloud Storage Modification - 10
* Command: Command Execution - 548
...
* Drive: Drive Creation - 10
* Drive: Drive Modification - 3
* Driver: Driver Load - 30
* File: File Access - 106
* File: File Creation - 212
* File: File Deletion - 23
* File: File Metadata - 99
* File: File Modification - 108
...
* Internet Scan: Response Content - 18
* Internet Scan: Response Metadata - 6
* Logon Session: Logon Session Creation - 79
* Logon Session: Logon Session Metadata - 42
* Malware Repository: Malware Content - 9
* Malware Repository: Malware Metadata - 35
* Module: Module Load - 100
* Named Pipe: Named Pipe Metadata - 5
* Network Share: Network Share Access - 24
* Network Traffic: Network Connection Creation - 165
* Network Traffic: Network Traffic Content - 234
* Network Traffic: Network Traffic Flow - 259
* Persona: Social Media - 2
* Process: OS API Execution - 204
* Process: Process Access - 47
* Process: Process Creation - 532
* Process: Process Metadata - 59
* Process: Process Modification - 8
* Process: Process Termination - 6
* Scheduled Job: Scheduled Job Creation - 17
* Scheduled Job: Scheduled Job Metadata - 11
* Scheduled Job: Scheduled Job Modification - 11
* Script: Script Execution - 108
* Sensor Health: Host Status - 9
* Service: Service Creation - 29
* Service: Service Metadata - 22
* Service: Service Modification - 11
...
* User Account: User Account Authentication - 40
* User Account: User Account Creation - 13
...
* Windows Registry: Windows Registry Key Creation - 57
* Windows Registry: Windows Registry Key Deletion - 13
* Windows Registry: Windows Registry Key Modification - 91
