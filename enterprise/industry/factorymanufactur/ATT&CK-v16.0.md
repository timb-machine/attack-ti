...
* Application Log: Application Log Content - 80
...
* File: File Access - 49
* File: File Creation - 91
* File: File Deletion - 5
* File: File Metadata - 38
...
* Logon Session: Logon Session Creation - 40
...
* Network Traffic: Network Connection Creation - 75
* Network Traffic: Network Traffic Content - 118
* Network Traffic: Network Traffic Flow - 107
* Persona: Social Media - 5
* Process: OS API Execution - 73
* Process: Process Access - 21
* Process: Process Creation - 198
...
* Windows Registry: Windows Registry Key Modification - 40
