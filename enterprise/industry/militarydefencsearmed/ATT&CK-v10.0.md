...
* Network Traffic: Network Traffic Content - 168
* Network Traffic: Network Traffic Flow - 145
* Persona: Social Media - 7
* Pod: Pod Metadata - 1
* Process: OS API Execution - 111
* Process: Process Access - 23
* Process: Process Creation - 333
...
* Web Credential: Web Credential Usage - 5
