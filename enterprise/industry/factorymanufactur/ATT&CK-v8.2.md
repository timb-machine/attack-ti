...
* Application control by file name or path - 11
...
* API monitoring - 13
* AWS CloudTrail logs - 8
* Anti-virus - 12
* Application logs - 2
* Authentication logs - 19
* Azure activity logs - 4
...
* Network protocol analysis - 34
* Packet capture - 43
* PowerShell logs - 15
* Process command-line parameters - 124
* Process monitoring - 162
* Process use of network - 47
* SSL/TLS inspection - 17
* Services - 1
* Stackdriver logs - 8
* System calls - 5
