...
* Application logs - 9
* Asset management - 1
* Authentication logs - 48
* Azure activity logs - 10
* BIOS - 1
* Binary file metadata - 38
* DLL monitoring - 40
* DNS records - 11
...
* Named Pipes - 4
* Netflow/Enclave netflow - 83
* Network device logs - 7
* Network intrusion detection system - 35
* Network protocol analysis - 71
* OAuth audit logs - 1
* Office 365 account logs - 7
* Office 365 trace logs - 1
* Packet capture - 92
* PowerShell logs - 36
* Process command-line parameters - 248
* Process monitoring - 328
* Process use of network - 96
* SSL/TLS inspection - 28
* Services - 1
* Stackdriver logs - 20
* System calls - 8
