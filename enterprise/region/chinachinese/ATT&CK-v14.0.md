...
* Host Intrusion Prevention Systems - 43
...
* File: File Creation - 214
* File: File Deletion - 15
* File: File Metadata - 98
* File: File Modification - 109
...
* Image: Image Metadata - 18
* Internet Scan: Response Content - 26
* Internet Scan: Response Metadata - 7
* Logon Session: Logon Session Creation - 60
* Logon Session: Logon Session Metadata - 32
* Malware Repository: Malware Content - 7
* Malware Repository: Malware Metadata - 27
* Module: Module Load - 97
* Named Pipe: Named Pipe Metadata - 4
* Network Share: Network Share Access - 14
* Network Traffic: Network Connection Creation - 151
* Network Traffic: Network Traffic Content - 228
* Network Traffic: Network Traffic Flow - 229
* Persona: Social Media - 3
* Process: OS API Execution - 225
* Process: Process Access - 44
* Process: Process Creation - 538
* Process: Process Metadata - 49
* Process: Process Modification - 7
* Process: Process Termination - 4
* Scheduled Job: Scheduled Job Creation - 16
* Scheduled Job: Scheduled Job Metadata - 8
* Scheduled Job: Scheduled Job Modification - 8
* Script: Script Execution - 122
* Sensor Health: Host Status - 8
* Service: Service Creation - 18
...
* WMI: WMI Creation - 31
* Windows Registry: Windows Registry Key Access - 30
* Windows Registry: Windows Registry Key Creation - 61
* Windows Registry: Windows Registry Key Deletion - 9
* Windows Registry: Windows Registry Key Modification - 79
