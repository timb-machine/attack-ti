...
* Network Traffic: Network Traffic Content - 59
* Network Traffic: Network Traffic Flow - 47
...
* Windows Registry: Windows Registry Key Access - 7
* Windows Registry: Windows Registry Key Creation - 8
* Windows Registry: Windows Registry Key Deletion - 1
* Windows Registry: Windows Registry Key Modification - 16
