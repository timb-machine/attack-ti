...
* Standard Application Layer Protocol - 12
* Standard Cryptographic Protocol - 7
...
* Anti-virus - 61
* Application whitelisting - 24
* Binary Analysis - 7
* Data Execution Prevention - 19
* Digital Certificate Validation - 10
* Exploit Prevention - 19
* File monitoring - 5
...
* MBR - 2
* Mail server - 32
* Malware reverse engineering - 44
* Named Pipes - 6
* Netflow/Enclave netflow - 105
* Network device logs - 12
* Network intrusion detection system - 52
* Network protocol analysis - 75
* Office 365 account logs - 18
* Office 365 trace logs - 3
* Packet capture - 128
* PowerShell logs - 42
* Process command-line parameters - 365
* Process monitoring - 499
* Process use of network - 137
* SSL/TLS inspection - 49
* Services - 5
* Stackdriver logs - 25
* System calls - 15
