...
* Application Log: Application Log Content - 90
...
* File: File Access - 60
* File: File Creation - 131
* File: File Deletion - 8
* File: File Metadata - 60
* File: File Modification - 62
...
* Network Traffic: Network Traffic Content - 176
* Network Traffic: Network Traffic Flow - 164
* Persona: Social Media - 6
* Process: OS API Execution - 123
* Process: Process Access - 26
* Process: Process Creation - 343
...
* Windows Registry: Windows Registry Key Creation - 44
