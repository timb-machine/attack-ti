...
* Driver: Driver Load - 9
* File: File Access - 37
* File: File Creation - 73
* File: File Deletion - 6
* File: File Metadata - 34
...
* Internet Scan: Response Content - 14
...
* Module: Module Load - 37
* Named Pipe: Named Pipe Metadata - 1
* Network Share: Network Share Access - 5
* Network Traffic: Network Connection Creation - 68
* Network Traffic: Network Traffic Content - 109
* Network Traffic: Network Traffic Flow - 92
* Persona: Social Media - 1
* Process: OS API Execution - 73
* Process: Process Access - 10
* Process: Process Creation - 194
...
* Windows Registry: Windows Registry Key Modification - 27
