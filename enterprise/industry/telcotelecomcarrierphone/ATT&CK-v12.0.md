...
* Network Traffic: Network Connection Creation - 92
* Network Traffic: Network Traffic Content - 123
* Network Traffic: Network Traffic Flow - 100
* Persona: Social Media - 1
* Pod: Pod Metadata - 1
* Process: OS API Execution - 120
...
* Windows Registry: Windows Registry Key Modification - 35
