...
* Application control by file name or path - 32
* Binary Analysis - 2
...
* Anti-virus - 60
* Application logs - 8
* Authentication logs - 70
* Azure activity logs - 26
* Binary file metadata - 84
* DLL monitoring - 52
* DNS records - 20
...
* MBR - 1
* Mail server - 45
* Malware reverse engineering - 35
* Named Pipes - 3
* Netflow/Enclave netflow - 129
* Network device logs - 14
* Network intrusion detection system - 63
* Network protocol analysis - 116
* OAuth audit logs - 1
...
* Packet capture - 164
* PowerShell logs - 74
* Process command-line parameters - 508
* Process monitoring - 656
* Process use of network - 163
* SSL/TLS certificates - 1
* SSL/TLS inspection - 64
* Services - 5
