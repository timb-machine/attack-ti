...
* Application Log: Application Log Content - 139
...
* Network Traffic: Network Connection Creation - 157
* Network Traffic: Network Traffic Content - 256
* Network Traffic: Network Traffic Flow - 193
* Persona: Social Media - 7
* Process: OS API Execution - 189
* Process: Process Access - 33
* Process: Process Creation - 453
