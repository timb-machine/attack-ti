...
* Exploits - 1
* External Proxy - 4
* External Remote Services - 10
* Fallback Channels - 1
* File Deletion - 14
* File Transfer Protocols - 2
* File and Directory Discovery - 21
* Fileless Storage - 2
* Financial Theft - 1
...
* Masquerading - 6
* Match Legitimate Name or Location - 21
* Modify Registry - 10
* Mshta - 10
* Msiexec - 1
...
* lateral-movement - 48
* persistence - 164
* privilege-escalation - 154
* reconnaissance - 45
* resource-development - 121
...
* Windows User Account Control - 13

# Validate the following data sources

* Active Directory: Active Directory Credential Request - 8
* Active Directory: Active Directory Object Access - 23
...
* Application Log: Application Log Content - 204
...
* Command: Command Execution - 772
* Container: Container Creation - 2
* Container: Container Start - 1
* Domain Name: Active DNS - 15
* Domain Name: Domain Registration - 15
* Domain Name: Passive DNS - 15
* Drive: Drive Creation - 6
* Driver: Driver Load - 35
* File: File Access - 154
* File: File Creation - 325
* File: File Deletion - 19
* File: File Metadata - 124
* File: File Modification - 147
* Firewall: Firewall Disable - 5
* Firewall: Firewall Enumeration - 20
* Firewall: Firewall Metadata - 20
...
* Image: Image Metadata - 27
* Instance: Instance Creation - 2
* Instance: Instance Deletion - 2
* Instance: Instance Metadata - 2
* Instance: Instance Start - 1
* Internet Scan: Response Content - 45
* Internet Scan: Response Metadata - 11
* Logon Session: Logon Session Creation - 91
* Logon Session: Logon Session Metadata - 49
* Malware Repository: Malware Content - 13
* Malware Repository: Malware Metadata - 42
* Module: Module Load - 129
* Named Pipe: Named Pipe Metadata - 5
* Network Share: Network Share Access - 18
* Network Traffic: Network Connection Creation - 229
* Network Traffic: Network Traffic Content - 377
* Network Traffic: Network Traffic Flow - 339
* Persona: Social Media - 8
* Process: OS API Execution - 313
* Process: Process Access - 63
* Process: Process Creation - 772
* Process: Process Metadata - 78
* Process: Process Modification - 13
* Process: Process Termination - 9
* Scheduled Job: Scheduled Job Creation - 25
* Scheduled Job: Scheduled Job Metadata - 14
* Scheduled Job: Scheduled Job Modification - 14
* Script: Script Execution - 175
* Sensor Health: Host Status - 10
* Service: Service Creation - 24
* Service: Service Metadata - 26
* Service: Service Modification - 7
* Snapshot: Snapshot Deletion - 1
* User Account: User Account Authentication - 45
...
* WMI: WMI Creation - 30
* Windows Registry: Windows Registry Key Access - 43
* Windows Registry: Windows Registry Key Creation - 79
* Windows Registry: Windows Registry Key Deletion - 18
* Windows Registry: Windows Registry Key Modification - 114
...
* https://assets.documentcloud.org/documents/20413525/fbi-flash-indicators-of-compromise-ragnar-locker-ransomware-11192020-bc.pdf - FBI. (2020, November 19). Indicators of Compromise Associated with Ragnar Locker Ransomware. Retrieved April 1, 2021.
