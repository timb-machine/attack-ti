...
* Application control by file name or path - 20
...
* Network Traffic: Network Traffic Content - 117
* Network Traffic: Network Traffic Flow - 109
* Persona: Social Media - 2
* Pod: Pod Metadata - 1
* Process: OS API Execution - 91
* Process: Process Access - 23
* Process: Process Creation - 254
...
* Windows Registry: Windows Registry Key Modification - 31
