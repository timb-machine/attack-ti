...
* API monitoring - 98
* AWS CloudTrail logs - 41
* Access tokens - 2
* Anti-virus - 58
* Application logs - 7
* Authentication logs - 69
* Azure activity logs - 35
* Binary file metadata - 83
* DLL monitoring - 48
* DNS records - 19
* Data loss prevention - 7
* Detonation chamber - 36
* Email gateway - 64
...
* Named Pipes - 3
* Netflow/Enclave netflow - 133
* Network device logs - 14
* Network intrusion detection system - 62
* Network protocol analysis - 114
* OAuth audit logs - 1
...
* Packet capture - 159
* PowerShell logs - 73
* Process command-line parameters - 497
* Process monitoring - 643
* Process use of network - 162
* SSL/TLS inspection - 62
* Services - 5
* Stackdriver logs - 41
* System calls - 24
