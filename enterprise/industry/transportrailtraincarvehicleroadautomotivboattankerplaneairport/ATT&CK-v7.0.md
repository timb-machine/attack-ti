...
* API monitoring - 37
* AWS CloudTrail logs - 21
* Anti-virus - 27
* Application logs - 4
* Authentication logs - 36
* Azure activity logs - 13
* BIOS - 1
* Binary file metadata - 33
* DLL monitoring - 27
* DNS records - 10
* Data loss prevention - 7
* Detonation chamber - 14
* Email gateway - 27
...
* Network protocol analysis - 58
* Office 365 account logs - 4
* Packet capture - 77
* PowerShell logs - 32
* Process command-line parameters - 205
* Process monitoring - 285
* Process use of network - 84
