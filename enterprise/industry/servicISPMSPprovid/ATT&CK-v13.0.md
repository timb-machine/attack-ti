...
* Application Log: Application Log Content - 63
* Cloud Storage: Cloud Storage Modification - 1
* Command: Command Execution - 145
...
* File: File Access - 28
* File: File Creation - 58
* File: File Deletion - 6
* File: File Metadata - 25
...
* Module: Module Load - 29
* Network Share: Network Share Access - 3
* Network Traffic: Network Connection Creation - 56
* Network Traffic: Network Traffic Content - 92
* Network Traffic: Network Traffic Flow - 67
* Persona: Social Media - 1
* Process: OS API Execution - 47
* Process: Process Access - 7
* Process: Process Creation - 139
* Process: Process Metadata - 17
...
* Windows Registry: Windows Registry Key Modification - 21
