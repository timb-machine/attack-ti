...
* Application control by file name or path - 10
* Autoruns Analysis - 1
...
* Network Traffic: Network Connection Creation - 41
* Network Traffic: Network Traffic Content - 67
* Network Traffic: Network Traffic Flow - 55
* Persona: Social Media - 4
* Process: OS API Execution - 38
* Process: Process Access - 12
* Process: Process Creation - 128
