...
* Process whitelisting - 43
* Signature-based detection - 27
* System access controls - 9
* Whitelisting by file name or path - 19
...
* Anti-virus - 26
* Application logs - 6
* Authentication logs - 51
* BIOS - 1
* Binary file metadata - 52
* DLL monitoring - 15
* DNS records - 3
* Data loss prevention - 3
* Detonation chamber - 11
* Email gateway - 21
...
* Named Pipes - 3
* Netflow/Enclave netflow - 52
* Network device logs - 6
* Network intrusion detection system - 26
* Network protocol analysis - 42
* Packet capture - 63
* PowerShell logs - 22
* Process command-line parameters - 207
* Process monitoring - 286
* Process use of network - 75
...
* https://en.wikipedia.org/wiki/Run_command - Wikipedia. (2018, August 3). Run Command. Retrieved October 12, 2018.
