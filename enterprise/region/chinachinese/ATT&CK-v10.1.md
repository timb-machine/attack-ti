...
* Two-Factor Authentication Interception - 2
* Unix Shell - 2
* Upload Tool - 1
...
* Command: Command Execution - 494
* Domain Name: Active DNS - 9
* Domain Name: Domain Registration - 9
...
* File: File Access - 98
* File: File Creation - 170
* File: File Deletion - 14
* File: File Metadata - 81
* File: File Modification - 97
...
* Logon Session: Logon Session Creation - 55
...
* Network Traffic: Network Connection Creation - 132
* Network Traffic: Network Traffic Content - 173
* Network Traffic: Network Traffic Flow - 170
* Persona: Social Media - 3
* Pod: Pod Metadata - 2
* Process: OS API Execution - 152
...
* Windows Registry: Windows Registry Key Modification - 57
